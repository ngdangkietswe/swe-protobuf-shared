...
func (m *LoginResp) GetResp() isLoginResp_Resp {
	if m != nil {
		return m.Resp
	}
	return nil
...
func (x *LoginResp) GetData() *LoginResp_Data {
	if x, ok := x.GetResp().(*LoginResp_Data_); ok {
		return x.Data
	}
	return nil
}
...
func (x *LoginResp) GetError() *common.Error {
	if x, ok := x.GetResp().(*LoginResp_Error); ok {
		return x.Error
	}
	return nil
}
...
var file_auth_shared_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x64, 0x65, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x42, 0x84,
...
var file_auth_shared_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_auth_shared_proto_goTypes = []any{
	...
	(*LoginResp_Data)(nil),         // 5: auth.LoginResp.Data
	(*common.Error)(nil),           // 6: common.Error
}
var file_auth_shared_proto_depIdxs = []int32{
	5, // 0: auth.LoginResp.data:type_name -> auth.LoginResp.Data
	6, // 1: auth.LoginResp.error:type_name -> common.Error
	6, // 2: auth.EnableOrDisable2FAResp.error:type_name -> common.Error
