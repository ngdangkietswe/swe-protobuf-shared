...
type StravaActivity struct {
	...
	Distance           float64                `protobuf:"fixed64,9,opt,name=distance,proto3" json:"distance,omitempty"`                         // Ex: 3.5 (km)
	...
	TotalElevationGain int32                  `protobuf:"varint,12,opt,name=total_elevation_gain,json=totalElevationGain,proto3" json:"total_elevation_gain,omitempty"`
...
var file_integration_shared_proto_rawDesc = string([]byte{
	...
	0x0c, 0x20, 0x01, 0x28, 0x05, 0x52, 0x12, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x45, 0x6c, 0x65, 0x76,
