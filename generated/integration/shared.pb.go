...
type StravaActivity struct {
	...
	Id                 string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	UserId             string                 `protobuf:"bytes,2,opt,name=user_id,json=userId,proto3" json:"user_id,omitempty"`
	StravaActivityId   int64                  `protobuf:"varint,3,opt,name=strava_activity_id,json=stravaActivityId,proto3" json:"strava_activity_id,omitempty"`
	...
	Distance           float64                `protobuf:"fixed64,8,opt,name=distance,proto3" json:"distance,omitempty"`                         // Ex: 3.5 (km)
	MovingTime         string                 `protobuf:"bytes,9,opt,name=moving_time,json=movingTime,proto3" json:"moving_time,omitempty"`     // Ex: 12:30 (HH:mm)
	ElapsedTime        string                 `protobuf:"bytes,10,opt,name=elapsed_time,json=elapsedTime,proto3" json:"elapsed_time,omitempty"` // Ex: 12:30 (HH:mm)
	TotalElevationGain int32                  `protobuf:"varint,11,opt,name=total_elevation_gain,json=totalElevationGain,proto3" json:"total_elevation_gain,omitempty"`
	AverageSpeed       float64                `protobuf:"fixed64,12,opt,name=average_speed,json=averageSpeed,proto3" json:"average_speed,omitempty"` // Ex: 4.5 (km/h)
	MaxSpeed           float64                `protobuf:"fixed64,13,opt,name=max_speed,json=maxSpeed,proto3" json:"max_speed,omitempty"`             // Ex: 10.0 (km/h)
	Pace               string                 `protobuf:"bytes,14,opt,name=pace,proto3" json:"pace,omitempty"`                                       // Ex: 05:00/km
...
func (x *StravaActivity) GetDistance() float64 {
	if x != nil {
		return x.Distance
	}
	return 0
...
func (x *StravaActivity) GetTotalElevationGain() int32 {
	if x != nil {
...
var file_integration_shared_proto_rawDesc = string([]byte{
	...
	0x41, 0x74, 0x22, 0xfa, 0x03, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x61, 0x76, 0x61, 0x41, 0x63, 0x74,
	...
	0x0a, 0x12, 0x73, 0x74, 0x72, 0x61, 0x76, 0x61, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74,
	0x79, 0x5f, 0x69, 0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x10, 0x73, 0x74, 0x72, 0x61,
	0x76, 0x61, 0x41, 0x63, 0x74, 0x69, 0x76, 0x69, 0x74, 0x79, 0x49, 0x64, 0x12, 0x23, 0x0a, 0x0d,
	...
	,
	...
	,
